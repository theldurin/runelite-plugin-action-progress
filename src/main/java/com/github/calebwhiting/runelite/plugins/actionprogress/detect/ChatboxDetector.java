...
public class ChatboxDetector extends ActionDetector
{
	...
	public void setup()
	{
		...
		this.registerAction(FLETCH_ATTACH, HEADLESS_ARROW, SEEKING_HEADLESS_ARROW, FLIGHTED_OGRE_ARROW, AMETHYST_BROAD_BOLTS, AMETHYST_ARROW, SEEKING_AMETHYST_ARROW);
